...
public:
    ...
    // Spring types
    enum SpringType { STRUCTURAL = 0x1, SHEAR = 0x2, BEND = 0x4 , DIAGONAL = 0x8}; 
...
protected:
	...
	virtual void AddDiagonalSpring(Particle& p1, Particle& p2);
	...
	virtual bool SphereIntersection(Particle& p, World::Sphere* sphere, JelloMesh::Intersection& intersection);
...
public:
	...
	static double g_diagonalKs;
	static double g_diagonalKd;
